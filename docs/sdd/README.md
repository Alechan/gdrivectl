...
- `0001-gdrivectl-sdd.md`: Initial architecture, CLI contract, and delivery plan for `gdrivectl`.
- `0002-v0-1-test-strategy-and-coverage-sdd.md`: Unit-test requirements for `fail`, `auth`, and CLI flag parsing.
